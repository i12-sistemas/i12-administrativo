...
<div class="container" id="topo">
    {{-- topo --}}
    {{-- <nav class="navbar navbar-expand-lg navbar-dark bg-danger fixed-top rounded">
   
        <a class="navbar-brand" href="#">Status Report</a>
        ...
        <div class="collapse navbar-collapse" id="navbarsExample09">
          <ul class="navbar-nav mr-auto">
            ...
            <li class="nav-item">
              <a class="nav-link" href="#">Marcar como lido</a>
            </li>
            <?php $i = 1; ?>
            ...
            <li class="nav-item dropdown">
              <a class="nav-link dropdown-toggle" href="http://example.com" id="dropdown09" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Fases</a>
    ...
    <div class="row" style="margin-top: 70px">
      ...
      <main role="main">
        ...
        @else
            ...
            <div class="logo">
                <img src="{{ asset('/assets/images/logos/' . $projeto->empresa->nomecurto . '.jpg' ) }}" class="image image-img-responsive" />
            </div>
