...
class RetApiController extends Controller
{
  ...
  public function toJson(){
      ...
      if ($debugmode) {
        ...
        $empresa_tenant = session('tenant_empresa');
      }
      ...
      if(!$this->collection){
          ...
          $dados = [
              ...
              'descending'    =>      ($classname == "Illuminate\Pagination\LengthAwarePaginator") ? ($this->descending === true) : false,
      ...
      //   if ($empresa_tenant) $security[] = ['empresa_tenant' => $empresa_tenant];
      //   if ($security)
      //     if(count($security)>0)
